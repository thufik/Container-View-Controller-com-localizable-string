...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //let tabBarConntrollerInheritedFromViewControllerWithCustomTabBar = MyTabBrController()

//        let tabBar = tabBarController(nibName: "tabBarController", bundle: Bundle.main)
        
        let tabBar = UITabBarController()
        
        tabBar.setViewControllers(self.viewControls, animated: true)
        
        
        
//        let firstView = FirstViewController()
//        
//        let tabBarItem = UITabBarItem(title: "X", image: nil, selectedImage: nil)
//    
//        firstView.tabBarItem = tabBarItem
//        tabBarController.setViewControllers([firstView,FirstViewController()], animated: true)
//        
